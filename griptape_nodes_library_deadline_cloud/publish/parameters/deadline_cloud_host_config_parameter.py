...
class DeadlineCloudHostConfigParameter:
    ...
    def _add_custom_amount_parameter(self, button: Button, button_details: ButtonDetailsMessagePayload) -> None:
        ...
        new_param = Parameter(
            ...
            parent_container_name="Host Config",
            user_defined=True,
        )
        self.node.add_parameter(new_param)

    def _add_custom_attribute_parameter(self, button: Button, button_details: ButtonDetailsMessagePayload) -> None:
    ...
    def _get_custom_requirement_parameters_by_type(self, custom_requirement_type: str) -> list[Parameter]:
        ...
        return [
            ...
            and p.parent_container_name == "Host Config"
        ]
